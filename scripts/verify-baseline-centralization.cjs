...
const requiredCurveSnapshotTokens = [
  ...
  "getAllianceStudioName",
  "getAllianceStudioName(customerName, allianceLabel, revenueStream)",
  "Alianças Google",
  "Alianças Microsoft",
  "Alianças AWS",
  "Datadog-Alianças",
  "google llc",
  "label.includes(\"google llc\")",
  "microsoft",
  "amazon web",
  "datadog",
  "isManagedServicesLabel",
  "Managed Services",
...
const requiredTargetParserTokens = [
  ...
  "businessUnit: indexes.businessUnit >= 0",
