...
const manager = (
  ...
  overrides: Partial<Pick<Person, "active" | "lifecycleStatus" | "closedAt" | "closedReason">> = {},
): Person => ({
  id,
  name,
  email: `${id}@brq.com`,
...
export const people: Person[] = [
  ...
  manager("cris", "Cris Koso", "ane", "Farmer + Delivery", undefined, { active: false, lifecycleStatus: "closed", closedAt: "2026-06-30", closedReason: "Encerramento" }),
