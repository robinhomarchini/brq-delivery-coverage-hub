...
import {
  ...
  getCustomerTargetPeople,
  getPrimaryHunterIdForCustomer,
  hasVisibleCurrencyAmount,
  sortCustomerRows,
  type CustomerAllocationCompositionData,
  type CustomerAllocationWarningData,
  type CustomerSortKey,
  type CustomerStudioCompositionData,
  type CustomerTargetBreakdown,
  type CustomerTargetPerson,
} from "@/lib/customers/customer-coverage-view-model";
