...
- No Relatorio de Metas, a visao `Pessoas x Clientes` deve ser exportavel em linhas: Meta propria Hunter, Studio Hunter, Meta propria Renovacao, Studio Manutencao e Sem valor. Na tela, como a pessoa ja e escolhida no combo, nao repetir Pessoa/Perfil na grade; no CSV/Excel manter Pessoa/E-mail/Perfil para auditoria. Studios devem aparecer como linhas com origem, studio, tipo e valores, nao como badges concatenados.
