-- Strengthen customer save cleanup for previously inconsistent data.
--
-- Renewal + Expansion target allocations from operational managers that are not
-- selected on the customer should be removed even if the manager/customer
-- assignment had already been removed in a previous save.
